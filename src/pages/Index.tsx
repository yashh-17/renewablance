          ...
          <div className="flex justify-center">
            <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md border border-gray-100">
              <div className="space-y-4">
                ...
                <div className="bg-white border border-gray-100 rounded-lg p-4 flex items-center justify-between shadow-sm hover:shadow transition-all">
                ...
                <div className="bg-warning-50 border border-warning-100 rounded-lg p-4 mt-2">
                  <div className="flex items-start space-x-3">
